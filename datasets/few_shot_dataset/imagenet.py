...
class ImageNet():
    ...
    def __init__(self, root, num_shots, preprocess):
        ...
        # modify 
        self.train = torchvision.datasets.ImageFolder(self.dataset_dir + '/train', transform=train_preprocess)
        self.val = torchvision.datasets.ImageFolder(self.dataset_dir + '/val', transform=test_preprocess)
        self.test = torchvision.datasets.ImageFolder(self.dataset_dir + '/val', transform=test_preprocess)
        ...
        for label, items in split_by_label_dict.items():
            if num_shots < 17:
                ...
                imgs = imgs + items
                targets = targets + [label for i in range(len(items))]
